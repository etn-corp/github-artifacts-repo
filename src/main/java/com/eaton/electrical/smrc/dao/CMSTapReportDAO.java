...
public class CMSTapReportDAO {
	...
	public static ArrayList executeReportSQL(String sql, Connection DBConn) throws Exception, SMRCException {
        ...
        try {
            ...
            CMSTapReportSearchResults resultHeaders = new CMSTapReportSearchResults();
            ...
            if(se.getErrorCode()==1013) {
                 ...
                 */
                SMRCLogger.warn("CMSTapReportDAO.executeReportSQL(): ",  se);
            ...
            SMRCLogger.error("CMSTapReportDAO.executeReportSQL(): SQL: " + sql);
            SMRCLogger.error("CMSTapReportDAO.executeReportSQL(): ", se);
            throw se;
            
        }catch (Exception e)	{
        		SMRCLogger.error("CMSTapReportDAO.executeReportSQL(): SQL: " + sql);
                SMRCLogger.error("CMSTapReportDAO.executeReportSQL(): ", e);
                throw e;
        }
        finally {
